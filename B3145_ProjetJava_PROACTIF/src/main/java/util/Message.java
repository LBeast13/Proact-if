...
public class Message {
    ...
    private static void debut() {
        ...
        OUT.println();
        OUT.println();
        OUT.println("---<([ MESSAGE @ " + TIMESTAMP_FORMAT.format(maintenant.getTime()) + " ])>---");
        OUT.println();
    }
    ...
    public static void envoyerMail(String mailExpediteur, String mailDestinataire, String objet, String corps) {
        ...
        GregorianCalendar maintenant =new GregorianCalendar();
        Message.debut();
        OUT.println("~~~ E-mail envoyé le " + HORODATE_FORMAT.format(maintenant.getTime()) + " ~~~");
    ...
    public static void envoyerNotification(String telephoneDestinataire, String message) {
        ...
        GregorianCalendar maintenant = new GregorianCalendar();
        Message.debut();
        OUT.println("~~~ Notification envoyée le " + HORODATE_FORMAT.format(maintenant.getTime()) + " ~~~");
