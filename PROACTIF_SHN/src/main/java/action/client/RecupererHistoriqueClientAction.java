 ...
 * @author Liam
 */
public class RecupererHistoriqueClientAction extends Action{
    ...
    public boolean executer(HttpServletRequest request, HttpSession session) {
        ...
        Client cli = Service.connecterClient(login, mdp);
        
        // Filtres
        String typeFiltre = (String) request.getParameter("type");
        String enCoursFiltre = (String) request.getParameter("enCours");
        
        List<Intervention> interventions = Service.recupererHistoriqueClient(cli);
