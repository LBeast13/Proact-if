...
function cloturerIntervention() {
    ...
    if (checkChampsValides()) {   // Si les champs sont valides
        $.ajax({
            ...
            method: 'POST',
            data: {
                todo: 'cloturer_intervention_en_cours',
                numero_interv: $.urlParam('numInterv'),
                date_cloture: $("#inputDateCloture").val(),
            ...
            numeroIntervention = $.urlParam('numInterv');
...
function isValidDate(dateString)
{
    ...
    var partsDemande = $("#dateDemande").text().split("/");
